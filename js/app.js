const db = {
    ...
    items: [
      {
        id: 0,
        title: "Producto Generico 1",
        price: 250,
        qty: 5,
      },
      {
        id: 1,
        title: "Producto Generico 2",
        price: 345,
        qty: 50,
      },
      {
        id: 2,
        title: "Producto Generico 3",
        price: 1300,
        qty: 80,
      },
      {
        id: 3,
        title: "Producto Generico 4",
        price: 1700,
        qty: 20,
      },
    ],
      ...
      return `
          <div class="item">
              ...
              <div class="actions"><button class="add" data-id="${
                item.id
              }">Añadir al carrito de compras</button></div>
          </div>`;
    });
    ...
    document.querySelectorAll(".item .actions .add").forEach((button) => {
      button.addEventListener("click", (e) => {
        ...
        if (item && item.qty - 1 > 0) {
          ...
          alert("Ya no hay existencia de ese articulo");
        }
      });
    });
  }
